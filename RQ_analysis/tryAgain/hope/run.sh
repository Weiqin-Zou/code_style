...
Rscript --slave filter.R pr_17_metrics.res cb11_10_rmallNA.res pr11_10_rmallNA.res pr_modiAmount.res $filter 
...
mv exp_corr.res ./corr_res/useCS_exp_corr_${filter}.res
mv expData_ori.res ./corr_res/useCS_expData_ori_${filter}.res
mv expData_nor.res ./corr_res/useCS_expData_nor_${filter}.res


./rm5diffMetrics.sh nouseCS_pr18_0.5.res nouseCS_cs21_0.5.res
mv exp_corr.res ./corr_res/nouseCS_exp_corr_${filter}.res
mv expData_ori.res ./corr_res/nouseCS_expData_ori_${filter}.res
mv expData_nor.res ./corr_res/nouseCS_expData_nor_${filter}.res
